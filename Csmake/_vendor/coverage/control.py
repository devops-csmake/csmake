...
from Csmake._vendor.coverage import env
from Csmake._vendor.coverage.annotate import AnnotateReporter
from Csmake._vendor.coverage.backward import string_class, iitems
from Csmake._vendor.coverage.collector import Collector, CTracer
from Csmake._vendor.coverage.config import read_coverage_config
from Csmake._vendor.coverage.context import should_start_context_test_function, combine_context_switchers
from Csmake._vendor.coverage.data import CoverageData, combine_parallel_data
from Csmake._vendor.coverage.debug import DebugControl, short_stack, write_formatted_info
from Csmake._vendor.coverage.disposition import disposition_debug_msg
from Csmake._vendor.coverage.files import PathAliases, abs_file, relative_filename, set_relative_directory
from Csmake._vendor.coverage.html import HtmlReporter
from Csmake._vendor.coverage.inorout import InOrOut
from Csmake._vendor.coverage.jsonreport import JsonReporter
from Csmake._vendor.coverage.misc import CoverageException, bool_or_none, join_regex
from Csmake._vendor.coverage.misc import DefaultValue, ensure_dir_for_file, isolate_module
from Csmake._vendor.coverage.plugin import FileReporter
from Csmake._vendor.coverage.plugin_support import Plugins
from Csmake._vendor.coverage.python import PythonFileReporter
from Csmake._vendor.coverage.report import render_report
from Csmake._vendor.coverage.results import Analysis, Numbers
from Csmake._vendor.coverage.summary import SummaryReporter
from Csmake._vendor.coverage.xmlreport import XmlReporter

try:
    from Csmake._vendor.coverage.multiproc import patch_multiprocessing
...
class Coverage(object):
    ...
    To use::
        ...
        from Csmake._vendor.coverage import Coverage
    ...
    def sys_info(self):
        ...
        import Csmake._vendor.coverage as covmod
...
if int(os.environ.get("COVERAGE_DEBUG_CALLS", 0)):              # pragma: debugging
    from Csmake._vendor.coverage.debug import decorate_methods, show_calls
...
def process_startup():
    ...
    #. Create or append to sitecustomize.py to add these lines::
        ...
        import Csmake._vendor.coverage
        coverage.process_startup()

    #. Create a .pth file in your Python installation containing::

        import Csmake._vendor.coverage; coverage.process_startup()
