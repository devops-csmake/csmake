...
from Csmake._vendor.coverage.backward import byte_to_int, bytes_to_ints, binary_bytes, zip_longest
from Csmake._vendor.coverage.misc import contract, new_contract
...
def register_sqlite_functions(connection):
    ...
    * :func:`numbits_to_nums`
    ...
    queries::
        ...
        import sqlite3
        from Csmake._vendor.coverage.numbits import register_sqlite_functions
