...
from Csmake._vendor.coverage.backward import litems, range     # pylint: disable=redefined-builtin
from Csmake._vendor.coverage.debug import short_stack
from Csmake._vendor.coverage.disposition import FileDisposition
from Csmake._vendor.coverage.misc import CoverageException, isolate_module
...
try:
    ...
    from Csmake._vendor.coverage.tracer import CTracer, CFileDisposition
except ImportError:
