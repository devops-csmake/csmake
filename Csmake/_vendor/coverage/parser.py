...
from Csmake._vendor.coverage.backward import range    # pylint: disable=redefined-builtin
from Csmake._vendor.coverage.backward import bytes_to_ints, string_class
from Csmake._vendor.coverage.bytecode import code_objects
from Csmake._vendor.coverage.debug import short_stack
from Csmake._vendor.coverage.misc import contract, join_regex, new_contract, nice_pair, one_of
from Csmake._vendor.coverage.misc import NoSource, NotPython, StopEverything
from Csmake._vendor.coverage.phystokens import compile_unicode, generate_tokens, neuter_encoding_declaration
...
class PythonParser(object):
    ...
    def __init__(self, text=None, filename=None, exclude=None):
        ...
        self.text = text
        if not self.text:
            from Csmake._vendor.coverage.python import get_python_source
            try:
