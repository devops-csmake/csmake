...
from Csmake._vendor.coverage.backward import BUILTINS
from Csmake._vendor.coverage.backward import PYC_MAGIC_NUMBER, imp, importlib_util_find_spec
from Csmake._vendor.coverage.files import canonical_filename, python_reported_file
from Csmake._vendor.coverage.misc import CoverageException, ExceptionDuringRun, NoCode, NoSource, isolate_module
from Csmake._vendor.coverage.phystokens import compile_unicode
