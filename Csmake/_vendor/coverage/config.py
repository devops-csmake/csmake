...
from Csmake._vendor.coverage.backward import configparser, iitems, string_class
from Csmake._vendor.coverage.misc import contract, CoverageException, isolate_module
from Csmake._vendor.coverage.misc import substitute_variables

from Csmake._vendor.coverage.tomlconfig import TomlConfigParser, TomlDecodeError
