...
from CsmakeCore._vendor.coverage.backward import code_object
from CsmakeCore._vendor.coverage.disposition import FileDisposition, disposition_init
from CsmakeCore._vendor.coverage.files import TreeMatcher, FnmatchMatcher, ModuleMatcher
from CsmakeCore._vendor.coverage.files import prep_patterns, find_python_files, canonical_filename
from CsmakeCore._vendor.coverage.misc import CoverageException
from CsmakeCore._vendor.coverage.python import source_for_file, source_for_morf
