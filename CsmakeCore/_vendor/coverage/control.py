...
from CsmakeCore._vendor.coverage import env
from CsmakeCore._vendor.coverage.annotate import AnnotateReporter
from CsmakeCore._vendor.coverage.backward import string_class, iitems
from CsmakeCore._vendor.coverage.collector import Collector, CTracer
from CsmakeCore._vendor.coverage.config import read_coverage_config
from CsmakeCore._vendor.coverage.context import should_start_context_test_function, combine_context_switchers
from CsmakeCore._vendor.coverage.data import CoverageData, combine_parallel_data
from CsmakeCore._vendor.coverage.debug import DebugControl, short_stack, write_formatted_info
from CsmakeCore._vendor.coverage.disposition import disposition_debug_msg
from CsmakeCore._vendor.coverage.files import PathAliases, abs_file, relative_filename, set_relative_directory
from CsmakeCore._vendor.coverage.html import HtmlReporter
from CsmakeCore._vendor.coverage.inorout import InOrOut
from CsmakeCore._vendor.coverage.jsonreport import JsonReporter
from CsmakeCore._vendor.coverage.misc import CoverageException, bool_or_none, join_regex
from CsmakeCore._vendor.coverage.misc import DefaultValue, ensure_dir_for_file, isolate_module
from CsmakeCore._vendor.coverage.plugin import FileReporter
from CsmakeCore._vendor.coverage.plugin_support import Plugins
from CsmakeCore._vendor.coverage.python import PythonFileReporter
from CsmakeCore._vendor.coverage.report import render_report
from CsmakeCore._vendor.coverage.results import Analysis, Numbers
from CsmakeCore._vendor.coverage.summary import SummaryReporter
from CsmakeCore._vendor.coverage.xmlreport import XmlReporter

try:
    from CsmakeCore._vendor.coverage.multiproc import patch_multiprocessing
...
class Coverage(object):
    ...
    To use::
        ...
        from CsmakeCore._vendor.coverage import Coverage
    ...
    def sys_info(self):
        ...
        import CsmakeCore._vendor.coverage as covmod
...
if int(os.environ.get("COVERAGE_DEBUG_CALLS", 0)):              # pragma: debugging
    from CsmakeCore._vendor.coverage.debug import decorate_methods, show_calls
...
def process_startup():
    ...
    #. Create or append to sitecustomize.py to add these lines::
        ...
        import CsmakeCore._vendor.coverage
        coverage.process_startup()

    #. Create a .pth file in your Python installation containing::

        import CsmakeCore._vendor.coverage; coverage.process_startup()
