...
from CsmakeCore._vendor.coverage.backward import litems, range     # pylint: disable=redefined-builtin
from CsmakeCore._vendor.coverage.debug import short_stack
from CsmakeCore._vendor.coverage.disposition import FileDisposition
from CsmakeCore._vendor.coverage.misc import CoverageException, isolate_module
...
try:
    ...
    from CsmakeCore._vendor.coverage.tracer import CTracer, CFileDisposition
except ImportError:
