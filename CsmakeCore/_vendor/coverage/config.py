...
from CsmakeCore._vendor.coverage.backward import configparser, iitems, string_class
from CsmakeCore._vendor.coverage.misc import contract, CoverageException, isolate_module
from CsmakeCore._vendor.coverage.misc import substitute_variables

from CsmakeCore._vendor.coverage.tomlconfig import TomlConfigParser, TomlDecodeError
