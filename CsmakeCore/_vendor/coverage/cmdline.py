...
from CsmakeCore._vendor.coverage.collector import CTracer
from CsmakeCore._vendor.coverage.data import line_counts
from CsmakeCore._vendor.coverage.debug import info_formatter, info_header, short_stack
from CsmakeCore._vendor.coverage.execfile import PyRunner
from CsmakeCore._vendor.coverage.misc import BaseCoverageException, ExceptionDuringRun, NoSource, output_encoding
from CsmakeCore._vendor.coverage.results import should_fail_under
...
def show_help(error=None, topic=None, parser=None):
    ...
    help_params = dict(CsmakeCore._vendor.coverage.__dict__)
